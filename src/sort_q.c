...
/*   Updated: 2025/02/07 22:51:25 by ozamora-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	qsort_recursive(int *arr, int low, int high);
...
static void	qsort_recursive(int *arr, int low, int high)
{
	...
	if (low < high)
	{
		...
		qsort_recursive(arr, low, pi - 1);
		qsort_recursive(arr, pi + 1, high);
	}
}
